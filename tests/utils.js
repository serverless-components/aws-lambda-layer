...
/*
 * Fetches a layer from aws for validation
 * @param ${object} credentials - the cross provider credentials object
 * @param ${string} arnVersion - the version arn of the layer
 */
const getLayer = async (credentials, arnVersion) => {
  const config = {
...
module.exports = { sleep, generateId, getCredentials, getServerlessSdk, getLayer }
